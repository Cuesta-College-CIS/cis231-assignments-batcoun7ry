/* 
 Question 1: Find the median value:
...
Question 2: Find the subsequence of the greatest sum:
• There are n integer elements in an array. We assume that all values are positive
• Find the 3 consecutive values of sub sequence that has the greatest sum.
    • Example: 1 25 10 5 20
    • Output: 25 10 5 ( since the sum is 40 which is greatest sum of 3 consecutive values)
• Input : n (positive integer value, the number of elements)
• Output : 3 integers (Consecutive 3 numbers in an array)
• Requirement
    • Make the main() method as compact, simple and well-organized as you can
        • Develop your own well-structured methods to find the solution
        • Use any parameters to send the information to the function
    • The values in an array should be filled up with random values between 0 and 99
        • After filling up the array, print all values in an array.
    • Any Java Class, Module, or Package can be used.
    • Test your programs with various test data
    •no other restrictions
 */
